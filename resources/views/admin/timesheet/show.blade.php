        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $total_salary = 0;                    
                    @endphp
                    @foreach($timesheet->payroll_details as $p)
                        @php
                    ...
                    <tr>                        
                        ...
                        <td class="text-right"><b>+ {{ number_format(($employee_data->allowance ?? 0),2) }}</b></td>
                    </tr>
                    <tr>
                        <td colspan="8" class="text-right"><b>Deduction Others (AUD)</b></td>
                        <td class="text-right"><b>- {{ number_format(($employee_data->deduction??0),2) }}</b></td>
                    </tr>
                    <tr>
                        <td colspan="8" class="text-right"><b>Deduction Tax (AUD)</b></td>
                        <td class="text-right"><b>- {{ number_format(($employee_data->emp_tax??0),2) }}</b></td>
                    </tr>
                    <tr>                        
                        <td colspan="8" class="text-right"><b>Grandtotal (AUD)</b></td>
                        <td class="text-right"><b>{{ number_format((($total_salary+($employee_data->allowance??0)) - (($employee_data->deduction??0) + ($employee_data->emp_tax??0))),2) }}</b></td>
                    </tr>
                </tbody>
            </table>
            <div class="form-group">
